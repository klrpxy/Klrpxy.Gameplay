...
| 包 | 当前版本 | 说明 | 文档 |
| --- | --- | --- | --- |
| Klrpxy Gameplay Tags | v0.2.1 | 类型安全、具备层级关系的 Gameplay Tag。 | [中文](src/Klrpxy.Gameplay.Tags/README.zh-CN.md) · [English](src/Klrpxy.Gameplay.Tags/README.md) |
| Klrpxy Gameplay Stats | v0.4.0 | 可组合、自动传播的属性、资源与 Group 规则。 | [中文](src/Klrpxy.Gameplay.Stats/README.zh-CN.md) · [English](src/Klrpxy.Gameplay.Stats/README.md) |
| Klrpxy Gameplay Stats R3 | v0.4.0 | 为 Stats 增加可选的 R3 动态值、条件和观察 API。 | [中文](src/Klrpxy.Gameplay.Stats/README.zh-CN.md#可选-r3-adapter) · [English](src/Klrpxy.Gameplay.Stats/README.md#optional-r3-adapter) |
...
3. 如需 R3 集成，先按 [R3 官方 Unity 安装说明](https://github.com/Cysharp/R3#unity)安装 R3 1.3.1，再导入 [Klrpxy Gameplay Stats R3 v0.4.0](https://github.com/klrpxy/Klrpxy.Gameplay/releases/download/v0.4.0/Klrpxy.Gameplay.Stats.R3.0.4.0.unitypackage)。

Stats 安装包不复制 Tags，R3 Adapter 也不捆绑 R3；请保持上述依赖顺序，避免项目中出现重复 DLL。

v0.4.0 使用独立的 `WithMinimum` / `WithMaximum` 声明固有边界，并移除 `WithBounds`。需要在 Resource 边界变化时保持比例，可追加 `PreserveRatioWhenBoundsChange()`。
